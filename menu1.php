...
<ul class="topnav">
<li class="right"><a href="see_bill_students.php" title="See Bill"> <i class="fa fa-eye"></i> See Bill</a></li>
</ul>
							...
							<center><img src='images/foodmenu.jpg' style='width:140px;height:140px;margin-top:0px;' alt='Food Order'></center>
								...
								while($data = mysqli_fetch_assoc($result))
								{
									...
									<form id='myform' name='myform' method='POST' autocomplete='off'>	
										...
										<center><img src='".$data['picture']."' style='width:140px;height:120px;margin-top:0px;' alt='".$data['food_name']."'></center>
										...
										<center><p style='font-size:18px;'>Calorie count:".$data['calorie']."</p></center>
